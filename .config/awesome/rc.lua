...
beautiful.init("/home/timmykill/.config/awesome/themes/default/theme.lua")
...
batterywidgettimer = timer({ timeout = 40 })    
batterywidgettimer:connect_signal("timeout",    
  function()    
    fh = assert(io.popen("acpi | cut -d, -f 2,3 - | cut -c2-11", "r"))    
...
tempwidgettimer = timer({ timeout = 2 })    
tempwidgettimer:connect_signal("timeout",    
  function()    
     t0 = assert(io.popen("sensors | grep Core -m1 | cut -c16-17", "r"))
     t1 = assert(io.popen("sensors | grep Core -m2 | tail -1 | cut -c16-17", "r"))
     tempwidget:set_text(" " .. t0:read("*l") .. "°C | " .. t1:read("*l") .. "°C ")    
    t0:close()
    t1:close()    
  end    
)    
...
globalkeys = awful.util.table.join(
   ...
   awful.key({ }, "XF86AudioRaiseVolume",    function ()
	 ...
	 awful.util.spawn("./.notify_alsa.sh") end),
   ...
   awful.key({ }, "XF86HomePage",    function ()
	 awful.util.spawn("inox") end),
   awful.key({ "Shift"}, "XF86HomePage",    function ()
	 awful.util.spawn("surf duckduckgo.com") end),
...
awful.util.spawn_with_shell("./Programmi/Scripts/tilda_config_reset.sh")
awful.util.spawn_with_shell("synclient EmulateMidButtonTime=100")
awful.util.spawn_with_shell("synclient VertEdgeScroll=1")
awful.util.spawn_with_shell("./Programmi/Scripts/atasmrk_battery_manager.sh")
awful.util.spawn_with_shell("setxkbmap it")
