...
beautiful.init("/home/timmykill/.config/awesome/themes/lain/theme.lua")
-- beautiful.init("/home/timmykill/.config/awesome/themes/material/theme.lua")
...
-- funzione per le hotkey, potrebbe tornare utile
...
-- Create an half delimiter
halfdelimiter = wibox.widget.textbox()
halfdelimiter:set_text(" | ")

-- Create a textclock widget
mytextclock = wibox.widget.textclock()
mytextclock:set_format("%a %b %d | %H:%M ")


--- {{{ Da implementare in modo un po' più efficiente
-- Create a battery level widget
...
globalkeys = gears.table.join(
	...
	awful.key({ "Shift" }, "#232", function()
			red_temp = red_temp > 1000 and red_temp  - 100 or red_temp
			awful.util.spawn("redshift -PO " .. red_temp ) 
		end ),
	awful.key({ "Shift" }, "#233", function() 
			red_temp = red_temp < 8000 and red_temp + 100 or red_temp
			awful.util.spawn("redshift -PO " .. red_temp ) 
		end ),
